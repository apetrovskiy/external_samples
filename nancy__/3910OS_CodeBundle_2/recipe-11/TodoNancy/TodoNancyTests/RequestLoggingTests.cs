namespace TodoNancyTests
{
  ...
  public class RequestLoggingTests
  {
    ...
    public void Should_log_incoming_requests(string path)
    {
      sut.Get(path);
    ...
    [Fact]
    public void Should_log_method_post()
    {
      sut.Post("/");
    ...
    [Fact]
    public void Should_log_method_put()
    {
      sut.Put("/");
    ...
    [Fact]
    public void Should_log_method_delete()
    {
      sut.Delete("/");
    ...
    [Fact]
    public void Should_log_error_on_failing_request()
    {
      try
      {

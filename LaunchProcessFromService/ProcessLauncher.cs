...
namespace LaunchProcessFromService
{
    ...
    {
        public const string Username = "someadministrator";
        ...
        public void LaunchService(object context)
        {
            ...
            // psi.UserName = "someadministrator"; // "LaunchProcessUser";
            ...
            psi.Password.AppendChar('t');
            */
            psi.Password.AppendChar('L');
            psi.Password.AppendChar('o');
            psi.Password.AppendChar('c');
            psi.Password.AppendChar('k');
            psi.Password.AppendChar('1');
            psi.Password.AppendChar('2');
            psi.Password.AppendChar('L');
            psi.Password.AppendChar('o');
            psi.Password.AppendChar('c');
            psi.Password.AppendChar('k');
